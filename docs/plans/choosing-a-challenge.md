...
- **Challenge 2's MVP corpus is fully self-contained.** The nine RAG PDFs are in the starter ZIP already (agent.md, Source 7) — you can build and test entirely offline once downloaded. No external API keys are needed or supplied.
